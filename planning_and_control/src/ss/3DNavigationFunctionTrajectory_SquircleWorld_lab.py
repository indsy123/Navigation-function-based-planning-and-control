...
class NavigationFunction_Trajectory3D(object):
    def __init__(self, name_of_uav, time_instance): 
        ...
        #self.WS = np.array([0.0, 0.0, 1, 1.0, 0.995, 0, 1.0, 1.0, 1.0]) # workspace
        self.WS = np.array([-0.18, 0.0, 0.5, 0.5, 0.995, 0, 1.0, 1.0, 0.5]) # workspace
        self.O1 = np.array([0.0, 0.0, 0.2005, 0.18, 0.995, 0, 1.0, 1.0, 0.45]) # obstacle 1
        ...
        self.goal = np.array([-0.75, 0.0, 0.1]); self.k = 6; self.lambda_sq = 10; self.lambda_sp = 10
